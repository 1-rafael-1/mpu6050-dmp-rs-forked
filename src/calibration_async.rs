    ...
    I: I2c,
{
    ...
    while !actions.is_empty() {
        let (new_actions, _, _, mag) = calibration_loop(mpu, delay, parameters, actions).await?;
        actions = new_actions;
        final_mag = mag;
    }
    Ok((
